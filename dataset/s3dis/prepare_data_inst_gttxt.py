...
def get_parser():
    ...
    parser.add_argument("--save-dir", type=str, default="./val_gt", help="directory save ground truth")
...
if __name__ == "__main__":
    ...
    for i, f in enumerate(files):
        (xyz, rgb, semantic_labels, instance_labels, room_label, scene) = torch.load(
            f
        )  # semantic label 0-12 instance_labels 0~instance_num-1 -100
