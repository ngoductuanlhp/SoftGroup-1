...
files = sorted(glob.glob('/vinai/tuannd42/DATASET/scannetv2/scans/*_vh_clean_2.ply'))
...
def f(fn):
    ...
    with open(fn4) as jsondata:
        ...
        for x in d['segGroups']:
            if scannet_util.g_raw2scannetv2[x['label']] != 'wall' and scannet_util.g_raw2scannetv2[
                ...
                instance_segids.append([x['segments'][0]])
    ...
    print('len label', np.count_nonzero(sem_labels != -100))
    otoc_dict = {}
...
final_dict = {}
files = sorted(glob.glob('/home/ubuntu/fewshot3d_ws/SoftGroup/dataset/scannetv2/points/points_otoc/scene*'))
...
torch.save(final_dict, f'/home/ubuntu/fewshot3d_ws/SoftGroup/dataset/scannetv2/points/points_otoc_dict.pth')
