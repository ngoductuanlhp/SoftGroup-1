...
CUDA_VISIBLE_DEVICES=2,7 OMP_NUM_THREADS=1 torchrun --nproc_per_node=2 --master_port=$((RANDOM + 10000)) tools/train.py --dist configs/softgroup_scannet_bbox_context.yaml --exp_name iou_conf
