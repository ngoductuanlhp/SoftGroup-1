...
CUDA_VISIBLE_DEVICES=4,7 OMP_NUM_THREADS=4 torchrun --nproc_per_node=2 --master_port=$((RANDOM + 10000)) tools/train.py --dist configs/softgroup_scannet_bbox_context_dycohead.yaml --exp_name geo_dist
CUDA_VISIBLE_DEVICES=7 python3 tools/train.py configs/softgroup_scannet_bbox_context_dycohead.yaml --exp_name debug