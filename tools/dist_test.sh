...
CUDA_VISIBLE_DEVICES=7 python3 tools/test.py configs/softgroup_scannet_bbox_context.yaml work_dirs/softgroup_scannet_bbox_context/softgroup_scannet_bbox_context_giouloss/best.pth